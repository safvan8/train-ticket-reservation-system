 ...
 * 
 * This class is used for transferring train-related data between different layers or components of the application.
 * It contains train information such as train number, name, stations, available seats, and fare.
 * 
 * @Author Safvan
 * @Version 1.0
 * @Since 1.0
