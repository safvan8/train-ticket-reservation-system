...
/**
 * The IBookingService interface provides methods for booking tickets and retrieving all tickets.
 *
 * @Author Safvan
 * @Version 1.0
 * @Since 1.0
...
public interface IBookingService {
	 ...
	 * @throws NoEnoughSeatsForBooking If there are not enough seats available on the train for booking.
