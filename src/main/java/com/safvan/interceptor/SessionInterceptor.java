...
public class SessionInterceptor implements HandlerInterceptor {
    ...
    /**
     * This method is executed before the controller handles the request. It checks if the user session is still active.
     * If the session has expired or the user is not logged in, it redirects them to the login page.
     *
