 ...
 * 
 * This interface extends the PagingAndSortingRepository interface provided by Spring Data.
 * It allows performing CRUD,Soring,paging operations and custom queries on the Train entity.
 * 
 * @Author Safvan
 * @Version 1.0
 * @Since 1.0
...
public interface ITrainRepository extends PagingAndSortingRepository<Train, Long> {
	/**
     * Custom query to find trains between two stations.
     * The query searches for trains where the fromStation and toStation match the provided parameters,
